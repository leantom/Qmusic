...
class NetworkManager: NSObject {
    ...
    func getChart(completionHandler: @escaping(Result<TrendingModel, Error>) -> Void) {
     
    
        let request = NSMutableURLRequest(url: NSURL(string: "https://c2ojyq8681.execute-api.ap-southeast-1.amazonaws.com/Prod/user?api=chart")! as URL,
